...
public class AdminPerformanceController {
    ...
    public String updatePerformance(@PathVariable("performanceId") Long id, Model model) {
        AdminPerformanceResponseDto performance = performanceService.getPerformanceUpdateForAdmin(
            id);
        List<PlaceResponseDto> places = performanceService.getAllPlaces();
    ...
    public String adminChart(
        ...
        Model model) {
        Pageable pageable = PageRequest.of(page, size);
        Page<AdminPerformanceStaticsDto> statics = performanceService.getPerformanceStatics(
            pageable);
