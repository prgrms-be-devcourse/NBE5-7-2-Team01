...
-- 대학로극장 (place_id = 3)
INSERT INTO grades (place_id, grade, seat_count, default_price, created_at, updated_at)
VALUES (3, 'S', 20, 100000, NOW(), NOW()),
       (3, 'A', 30, 75000, NOW(), NOW()),
       (3, 'B', 30, 50000, NOW(), NOW()),
       (3, 'C', 20, 25000, NOW(), NOW());

-- 해운대문화회관 (place_id = 4)
INSERT INTO grades (place_id, grade, seat_count, default_price, created_at, updated_at)
VALUES (4, 'S', 20, 90000, NOW(), NOW()),
       (4, 'A', 30, 70000, NOW(), NOW()),
       (4, 'B', 30, 50000, NOW(), NOW()),
       (4, 'C', 20, 20000, NOW(), NOW());

-- 3. 파일 정보 (id 명시적으로 지정)
INSERT INTO files (original_file_name, encoded_file_name, created_at, updated_at)
VALUES ('001.png', 'a1f2-001.png', NOW(), NOW()),
       ('001.png', 'b3c4-001.png', NOW(), NOW()),
       ('001.png', 'c5d6-001.png', NOW(), NOW()),
       ('001.png', 'd7e8-001.png', NOW(), NOW());
